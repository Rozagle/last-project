  ...
  return (
    <div id='policyprivacy' className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <section className="mb-8">
            ...
            <p>{t('PolicyPrivacyPage.sub8title1')}<a href="mailto:info@siyeso.com" className="text-blue-500">info@siyeso.com</a></p>
      ...
      <footer className="bg-black py-4 text-center">
        ...
        <a href="mailto:info@siyeso.com" className="text-blue-500">info@siyeso.com</a>
