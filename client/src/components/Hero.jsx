    ...
    <>
      <div className='max-w-[6840px] max-h-[780px] lg:max-h-[633px] xxs:min-h-[500px] flex flex-col md:flex-row sm:flex-row ss:flex-row xs:flex-row xxs:flex-row items-center justify-center bg-cover bg-center text-white relative z-1' style={{
        ...
        <div className="left-side flex flex-col justify-center px-16 xxs:px-10 text-center lg:w-4/5 md:w-1/2 sm:w-2/3 ss:w-4/5 xs:w-4/5 xxs:w-full lg:pb-32 md:pb-72 sm:pb-64 ss:pb-72 xs:pb-42 xs:pl-8 sm:me-2 xxs:p-8 xxs:pt-12 sm:pl-6 ss:pl-4 xxs:pb-36 sm:mr-8 md:text-left sm:text-left sm:text-lg ss:text-left xs:text-left xxs:text-left xxs:text-xs  " style={{
          ...
          <h3 className='text-2xl md:text-3xl sm:text-3xl xs:text-2xl xxs:text-[12px] xxs:mb-0  font-bold mb-2'>
            {t('left_side_hero.heading')}
          </h3>
        </div>

        {/* Right-side Hero */}
        <div className=" right-side flex lg:mr-40 lg:pt-8 md:w-1/2  xxs:pl-4" style={{
          zIndex: -1,
          WebkitUserSelect: 'none', 
        }}>
