...
function About() {
  ...
  return (
    ...
    <>
      <section id="about" className="px-3 xl:px-2 md:lg:xl:px-40 py-20 bg-opacity-10 max-w-[1400px] mx-auto desktopSmall:pt-32" style={{ zIndex: -1 }}>
        {/* max-w-[1132px] */}
        ...
        <div className='lg:w-8/10 md:w-full xs:w-full xxs:w-full mx-auto flex flex-col lg:flex-row md:flex-col lg:mt-8 xl:mt-12 justify-between items-center  '>
          ...
          <div className=' lg:w-full md:w-full xxs:w-1\4 m-3  lg:mt-6 xl:mb-12'>
