...
function About() {
  ...
  return (
    <section id='about' className='p-2  min-h-[600px] lg:min-h-[745px] pt-20 select-none'>
      <div className='px-4 lg:px-30 mx-auto my-8'>
        <div className='flex space-y-2 flex-col text-center mb-14 xs:mb-8 '>
          <h1 className=" text-2xl lg:text-[40px] md:text-4xl sm:text-4xl xs:text-2xl xxs:text-4xl  font-bold text-center mt-8 mb-4 capitalize">
            {t('AboutPage.heading')}
          </h1>
        </div>
        <div className='md:w-8/10 xs:w-full xxs:w-full md:mr-4  mx-auto flex flex-col md:flex-row justify-between items-center '>
          ...
          <div className=' lg:w-full md:w-full xxs:w-1\4 m-3'>
