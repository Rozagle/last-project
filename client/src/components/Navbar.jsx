...
function Navbar() {
    ...
    return (
        <div className="navbar bg-transparent absolute top-0 left-0 right-0">
            <div className="navigationBar text-white flex justify-between items-center h-16 max-w-[1450px] mx-auto px-5 relative">
                <div className="select-none w-36 h-36 lg:w-44 lg:h-44 sm:w-[190px] sm:h-[190px] xsm:w-40 xsm:h-40 xxs:w-[140px] xxs:h-[140px] lg:pt-6 sm:pt-4 xsm:pt-3 relative flex items-center">
                    <img
                        className="select-none w-36 h-36 lg:w-44 lg:h-44 sm:w-[190px] sm:h-[190px] xxs:w-[140px] xxs:h-[140px] xsm:w-40 xsm:h-40 mr-2"
                        alt=""
                ...
                <nav className="menu hidden lg:flex text-center justify-center text-lg font-semibold capitalize gap-8" style={{ flexWrap: 'nowrap' }}>
                    {navLinks.map((item) => (
                        <Link
                            key={item.key}
                            to={item.path}
