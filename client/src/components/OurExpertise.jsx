        ...
        <>
            <section  className="px-3 md:lg:xl:px-40 py-20 bg-opacity-10 max-w-[1500px] mx-auto" style={{ zIndex: -1 }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-2 group bg-none rounded-3xl p-4" style={{ zIndex: -1 }}>
                    <div className="p-10 flex flex-col items-center text-center group border-2 border-gray-700 bg-white rounded-3xl hover:bg-slate-50 cursor-pointer shadow-md hover:translate-y-1 transition-all duration-500 select-none " >
                        <img src={icon1} alt="" className="p-4 rounded-xl  border-2 border-black bg-[#ff7d37] text-white shadow-lg shadow-red-200"></img>
                        <p className="text-2xl md:text-3xl xxs:text-2xl xs:text-3xl font-medium text-slate-700 m-3">{t('OurExpertisePage.firstgridheading')}</p>
                        <p className="mt-2 text-md md:text-xl xxs:text-xl xs:text-2xl text-slate-500">{t('OurExpertisePage.firstgridsubheading1')}</p>
                        <p className="text-md md:text-xl xxs:text-xl xs:text-2xl text-slate-500">{t('OurExpertisePage.firstgridsubheading2')}</p>
                    </div>

                    <div className="p-10 flex flex-col items-center text-center group border-2  border-gray-700 bg-white rounded-3xl hover:bg-slate-50 cursor-pointer shadow-md hover:translate-y-1 transition-all duration-500 select-none ">
                        <img src={icon2} alt="" className="p-4 rounded-xl border-2 border-black bg-[#F33E33] text-white shadow-lg shadow-orange-200"></img>
                        <p className="text-2xl md:text-3xl xxs:text-2xl xs:text-3xl font-medium text-slate-700 m-3">{t('OurExpertisePage.secondgridheading')}</p>
                        <p className="mt-0 text-md md:text-xl xxs:text-lg xs:text-2xl text-slate-500">{t('OurExpertisePage.secondgridsubheading1')}</p>
                        <p className="mt-0 text-md md:text-xl xxs:text-lg xs:text-2xl text-slate-500">{t('OurExpertisePage.secondgridsubheading2')}</p>

                    </div>

                    <div className="p-10 flex flex-col items-center text-center group border-2  border-gray-700 bg-white rounded-3xl hover:bg-slate-50 cursor-pointer shadow-md hover:translate-y-1 transition-all duration-500 select-none">
                        <img src={icon3} alt="" className="p-4 rounded-xl  border-2 border-black bg-[#04ff00dd] text-white shadow-lg shadow-yellow-200"></img>
                        <p className="text-2xl md:text-3xl xxs:text-2xl xs:text-3xl font-medium text-slate-700 m-3">{t('OurExpertisePage.thirdgridhaeding')}</p>
                    ...
                    <div className="p-10 flex flex-col items-center text-center group border-2  border-gray-700 bg-white rounded-3xl hover:bg-slate-50 cursor-pointer shadow-md hover:translate-y-1 transition-all duration-500 select-none">
                        ...
                        <p className="text-2xl xxs:text-2xl md:text-3xl xs:text-3xl font-medium text-slate-700 m-3">{t('OurExpertisePage.forthgridheading')}</p>
